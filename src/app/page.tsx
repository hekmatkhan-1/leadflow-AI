    ...
    <div className="flex min-h-screen flex-col">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="pointer-events-none absolute inset-0 -z-10">
          <div className="absolute -left-40 -top-40 h-[500px] w-[500px] animate-pulse rounded-full bg-gradient-to-br from-blue-400/20 to-cyan-400/10 blur-3xl dark:from-blue-600/10 dark:to-cyan-600/5" />
          <div className="absolute -bottom-40 -right-40 h-[500px] w-[500px] animate-pulse rounded-full bg-gradient-to-br from-amber-400/20 to-orange-400/10 blur-3xl [animation-delay:1.5s] dark:from-amber-600/10 dark:to-orange-600/5" />
        </div>
            ...
            {features.map((feature, i) => {
              ...
              return (
                <FadeIn key={feature.title} delay={i * 120}>
                  <div className="group relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-8 shadow-sm transition-all hover:-translate-y-1 hover:shadow-lg dark:border-gray-800 dark:bg-gray-900">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-3">
            {[
              ...
              <FadeIn key={item.title} delay={i * 120}>
                <div className="rounded-xl border border-gray-200 bg-white p-6 text-center shadow-sm transition-all hover:-translate-y-1 hover:shadow-md dark:border-gray-800 dark:bg-gray-900">
          ...
          <FadeIn>
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-gray-900 via-blue-950 to-gray-900 px-8 py-16 text-center shadow-2xl sm:px-16">
              ...
              <div className="pointer-events-none absolute -inset-1">
                <div className="absolute left-1/2 top-0 h-[300px] w-[600px] -translate-x-1/2 animate-pulse rounded-full bg-gradient-to-br from-blue-500/20 to-cyan-500/10 blur-3xl" />
              </div>
              ...
              <div className="relative">
                ...
                <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
                  <Link
                    href="/signup"
                    className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-blue-500 to-cyan-400 px-8 py-3.5 text-base font-semibold text-gray-900 shadow-lg transition-all hover:from-blue-400 hover:to-cyan-300 hover:-translate-y-0.5 sm:w-auto"
                  >
                    Get Started Free
                    <ArrowRight className="h-5 w-5" />
                  </Link>
                  <Link
                    href="/login"
                    className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-gray-600 px-8 py-3.5 text-base font-semibold text-gray-200 transition-all hover:border-gray-500 hover:bg-white/5 hover:-translate-y-0.5 sm:w-auto"
                  >
                    Sign in
                  </Link>
                </div>
