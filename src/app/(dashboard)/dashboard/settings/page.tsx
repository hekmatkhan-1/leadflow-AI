...
// ---------------------------------------------------------------------------
// Settings page — chatbot configuration, branding, embed code
// ---------------------------------------------------------------------------
...
export default async function SettingsPage() {
  ...
  // Placeholder settings — in production these would come from the `businesses` table
        ...
        <CardContent className="space-y-4">
          ...
          <div className="relative">
            ...
            <Button
              ...
              onClick={() => {
                // Copy would be wired up in a client component
              }}
            >
              Copy
            </Button>
